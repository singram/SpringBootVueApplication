    ...
    <section class="todoapp">
      ...
      <div v-else>
        ...
        <footer class="footer" v-show="todos.length" v-cloak>
          ...
          <ul class="filters">
            <li><a href="#/all" @click="setVisibility('all')" v-bind:class="{ selected: visibility == 'all' }">All</a></li>
            <li><a href="#/active" @click="setVisibility('active')" v-bind:class="{ selected: visibility == 'active' }">Active</a></li>
            <li><a href="#/completed" @click="setVisibility('completed')" v-bind:class="{ selected: visibility == 'completed' }">Completed</a></li>
          </ul>
